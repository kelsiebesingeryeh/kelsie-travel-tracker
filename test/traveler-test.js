...
describe("Traveler", () => {
  beforeEach(() => {
    traveler1 = new Traveler(travelerData1, testTrips, testDestinations);
  });

  it("Should have a property of trips with a default value", () => {
    const expectedTrips = traveler1.getAllTravelersTrips();
    expect(traveler1.trips).to.eql(expectedTrips);
  });
